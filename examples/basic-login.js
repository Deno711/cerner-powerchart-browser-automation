/**
 * basic-login.js — Basic login example for Cerner PowerChart
...
async function main() {
  ...
  try {
    log('Starting Cerner PowerChart automation (Open Source mode)');
    ...
    const result = await login_powerchart(page, {
